...
copy %QT4DIR%\bin\QtOpenGl4.dll content\  
copy %QT4DIR%\bin\QtGUI4.dll content\ 
copy %QT4DIR%\bin\QtCore4.dll content\  
copy %QT4DIR%\bin\QtXml4.dll content\  
rem copy *.manifest content\ 
copy EULA.txt content\  
copy License.txt content\  
copy ReadMe.txt content\  
