	...
	namespace GUI {
		...
		public:
			...
			EisenScriptHighlighter(QTextEdit* e) : QSyntaxHighlighter(e) {
				...
				expression = QRegExp("(set|maxsize|minsize|translation|pivot|rotation|scale|maxobjects|background|color|rule|a|alpha|matrix|h|hue|sat|b|brightness|v|x|y|z|rx|ry|rz|s|fx|fy|fz|maxdepth|weight|md|w)");
